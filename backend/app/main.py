...
from app.api.broker_connection_routes import router as broker_connection_router
...
from app.api.performance_history_routes import \
    router as performance_history_router
...
from app.api.strategy_performance_routes import \
...
from app.api.telegram_notification_routes import \
    router as telegram_notification_router
...
from app.models import (BrokerConnection, EconomicEvent, MarketData,
                        MarketRegime, MarketSession, PaperTrade,
                        PerformanceHistory, Prediction, Signal, Strategy,
                        StrategyPerformance, StrategyRanking,
                        TelegramNotification, TradeResult)

app = FastAPI(title="Ric Research Lab")
...
app.include_router(broker_connection_router)
