...
from app.services.strategy_performance_service import (
    ...
    get_strategy_performances,
    get_strategy_performance_by_id,
    update_strategy_performance,
    delete_strategy_performance
)

router = APIRouter(
    prefix="/strategy-performance",
...
def get_strategy_performances_endpoint(
    db: Session = Depends(get_db)
):
...
def get_strategy_performance_by_id_endpoint(
    ...
    performance = get_strategy_performance_by_id(
        db,
        performance_id
    )
