...
@router.get(
    "/",
    response_model=list[MarketRegimeResponse]
)
...
def get_market_regime_by_id_endpoint(
    ...
    market_regime = get_market_regime_by_id(
        db,
        market_regime_id
    )
...
def delete_market_regime_endpoint(
    market_regime_id: int,
    db: Session = Depends(get_db)
):
    deleted_market_regime = delete_market_regime(
        db,
        market_regime_id
    )
