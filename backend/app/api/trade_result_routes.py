...
from app.schemas.trade_result import (
    TradeResultCreate,
    TradeResultResponse
)

from app.services.trade_result_service import (
    create_trade_result,
    get_trade_results,
...
def create_trade_result_endpoint(
    trade_result: TradeResultCreate,
...
def get_trade_results_endpoint(
    db: Session = Depends(get_db)
):
...
def get_trade_result_by_id_endpoint(
    ...
    trade_result = get_trade_result_by_id(
        db,
        trade_result_id
    )
...
def delete_trade_result_endpoint(
    trade_result_id: int,
    db: Session = Depends(get_db)
):
    deleted_trade_result = delete_trade_result(
        db,
        trade_result_id
    )
